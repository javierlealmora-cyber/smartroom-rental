...
CREATE TRIGGER lock_access_actors_updated_at BEFORE UPDATE ON public.lock_access_actors FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER lock_access_groups_updated_at BEFORE UPDATE ON public.lock_access_groups FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER lock_access_group_members_updated_at BEFORE UPDATE ON public.lock_access_group_members FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER lock_access_group_scopes_updated_at BEFORE UPDATE ON public.lock_access_group_scopes FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER lock_access_grants_updated_at BEFORE UPDATE ON public.lock_access_grants FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER lock_credentials_updated_at BEFORE UPDATE ON public.lock_credentials FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER lock_notifications_updated_at BEFORE UPDATE ON public.lock_notifications FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER update_lodger_accompanists_updated_at BEFORE UPDATE ON public.lodger_accompanists FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();