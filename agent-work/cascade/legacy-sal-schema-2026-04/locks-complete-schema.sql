...
CREATE UNIQUE INDEX lock_integrations_client_account_id_provider_key ON public.lock_integrations USING btree (client_account_id, provider);
...
CREATE UNIQUE INDEX locks_lock_integration_id_provider_lock_id_key ON public.locks USING btree (lock_integration_id, provider_lock_id);
