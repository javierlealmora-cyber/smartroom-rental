@echo off
REM ============================================================================
REM Script: backup-dev.bat
REM Descripción: Backup de Development/Staging usando Supabase CLI
REM ============================================================================

echo ========================================
echo Backup de Development/Staging
echo ========================================
echo.
...
set BACKUP_FILE=backup_dev_20260305.sql
